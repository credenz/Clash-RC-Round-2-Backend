...
def run_test_case(test_case_no, user_que_path, code_file_path, lang, qno,custominput="false"):
    if custominput=="true":
...
def exec_main(username, qno, lang,custominput="false", attempts=None, run=False):
